...
flowchart TB
    subgraph DataSources["Data Sources"]
        SpotPrices["AWS Spot Price History<br/>(describe_spot_price_history)"]
        SpotAdvisor["AWS Spot Advisor<br/>(Interruption Frequency Rank 1-5)"]
...
```mermaid
flowchart TD
    AllPools["All Spot Pools in Region<br/>(~500-2000 pools)"]
    
    Gate1{"Gate 1: ONNX Hard Gate<br/>risk_probability ≤ 0.35?<br/>(ml_model/risk_threshold.json)"}
    AllPools --> Gate1
    Gate1 -->|"Pass"| Gate2
