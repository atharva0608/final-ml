    ...
    <div className="max-w-screen-xl mx-auto space-y-6">
      <div className="flex items-center gap-3">
        ...
        <div>
          ...
          <p className="text-sm text-gray-500 mt-0.5">Chronological feed of cluster and agent events</p>
        </div>
      </div>
      <div className="bg-white rounded-lg border border-gray-200 shadow-sm flex flex-col items-center justify-center py-24 gap-4">
        <FiActivity className="w-12 h-12 text-gray-200" />
        <p className="text-gray-400 text-sm font-medium">Event Timeline coming soon</p>
