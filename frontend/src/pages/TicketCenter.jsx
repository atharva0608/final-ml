...
const TicketCenter = () => {
    ...
    const handleAccept = async (id) => {
        try {
            await ticketsAPI.acceptGrant(id);
    ...
    const handleReject = async (id) => {
        ...
        try {
            await ticketsAPI.rejectGrant(id);
            ...
            <div className="flex justify-between items-center">
                <div>
                    ...
                    <p className="text-sm text-gray-500 mt-1">
                        {isOrgAdmin ? 'Manage access requests and active grants' : 'Manage your access requests'}
                    </p>
                </div>
                                    ...
                                    <tr key={ticket.id} className="hover:bg-gray-50 transition-colors">
                                        <td className="px-6 py-4 whitespace-nowrap">
                                            <div className="flex items-center">
                                                <span className={`w-2 h-2 rounded-full mr-2 ${ticket.type === 'ACTION' ? 'bg-orange-400' : 'bg-blue-400'}`}></span>
